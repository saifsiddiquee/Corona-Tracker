package com.saif.coronatracker.adapters;
...
public class CountryAdapter extends RecyclerView.Adapter<CountryAdapter.CountryHolder> implements Filterable {
    ...
    public void onBindViewHolder(CountryHolder holder, final int position) {
        holder.countryCases.setText("Total Cases : " + countriesListed.get(position).getCases());
        holder.countryRecovered.setText("Recovered : " + countriesListed.get(position).getRecovered());
        holder.countryName.setText(countriesListed.get(position).getCountry());

        Picasso.get().load(countriesListed.get(position).getCountryInfo().getFlag())
                ...
                .into(holder.image, new com.squareup.picasso.Callback() {
                    ...
                    public void onSuccess() {
                        ...
                        holder.image.animate().setDuration(800).alpha(1f).start();
                    }
    ...
    public class CountryHolder extends RecyclerView.ViewHolder {
        ...
        public CountryHolder(View v) {
            ...
            countryCases = v.findViewById(R.id.tvCases);
            countryRecovered = v.findViewById(R.id.tvRecovered);
